...
export const defaultTheme = generateTheme({
    primaryColor: '#6e41e2',
    websiteName: 'Hire Agent',
    fullLogoUrl: 'https://i.ibb.co/MyMDdpwN/365-ai-tech-logo.jpg',
    favIconUrl: 'https://i.ibb.co/MyMDdpwN/365-ai-tech-logo.jpg',
    logoIconUrl: 'https://i.ibb.co/MyMDdpwN/365-ai-tech-logo.jpg',
})
